...
**Также избегай признаков AI-генерации:**  
> [⚠️ NO_AI_MARKERS.md](./NO_AI_MARKERS.md) — как не выглядеть как нейросеть (особенно внимание на тире!)
...
> **ВАЖНО:** Стиль выбирается **в зависимости от темы и материала**. Анализируй содержание и выбирай наиболее подходящий визуальный стиль.
