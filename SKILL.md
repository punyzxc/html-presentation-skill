...
## 📚 ВАЖНО: Верификация информации

> **Перед созданием презентации обязательно прочитай:**  
> [📖 RESEARCH_GUIDE.md](./RESEARCH_GUIDE.md) — полное руководство по поиску и проверке информации

**Зачем это нужно:**
- ✅ Избежать ошибок при выступлении
- ✅ Уметь защитить каждый факт
- ✅ Выглядеть профессионально
- ✅ Не "краснеть" при замечаниях

**Кратко:**
1. Используй только Level 1-2 источники (научные журналы, ООН, правительство, авторитетные СМИ)
2. Проверяй информацию по "треугольнику доверия" (3 источника)
3. Добавляй источники в конце презентации
4. Упоминай источники когда приводишь цифры
